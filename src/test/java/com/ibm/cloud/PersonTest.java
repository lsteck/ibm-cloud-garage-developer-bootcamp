...
public class PersonTest extends TestCase {
    ...
    public void testSpace() throws PersonParseException {
        ...
        Person person1 = PersonLoader.parser(input1, elements, delimiter);
        ...
        Person person2 = PersonLoader.parser(input2, elements, delimiter);
        ...
        Person person3 = PersonLoader.parser(input3, elements, delimiter);
